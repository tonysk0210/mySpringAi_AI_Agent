...
告別人工客服的瓶頸。**mySpringAi AI Agent** 是一套以 **Spring Boot + Spring AI + OpenAI** 打造的自主式 AI 客服代理系統，能在數秒內讀懂客戶來信、查詢訂單與付款紀錄、執行退款，並以正確語言自動回覆——24 小時不間斷，全程零人工介入。

> 從信件進入信箱到客戶收到回覆，整個流程由 LLM 自主驅動：識別意圖、蒐集事實、做出決策、記錄工單。工程師無需硬編碼任何業務流程，AI 自己找到正確的答案。
