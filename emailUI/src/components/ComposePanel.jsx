...
export default function ComposePanel({ onSend, displayResult }) {
  ...
  async function handleSubmit(e) {
    ...
    const params = new URLSearchParams({ from, subject, body })
    try {
      ...
      {displayResult && (
        ...
        >
          <div className="result-header">
            ...
            <div>
              <div className={`result-status-badge badge-${displayResult.status}`}>
          ...
          <div className="result-fields">
            ...
            {displayResult.body && (
              <div className="result-field">
                ...
                <span className="field-value body-value">{displayResult.body}</span>
              </div>
            )}
            {displayResult.error && (
              <div className="result-field">
                <span className="field-label error-label">錯誤</span>
                <span className="field-value error-value">{displayResult.error}</span>
              </div>
            )}
